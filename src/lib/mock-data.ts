...
export const ENTRIES: Record<string, Entry> = {
  "2026-05-13": {
    date: "2026-05-13",
    items: ["朝のコーヒーがいつもより美味しかった。豆を変えたから。", "プレゼンで上司に「分かりやすかった」と言われた。", ""],
    mood: "neutral",
    tags: ["仕事", "コーヒー"],
  },
  "2026-05-12": {
  ...
  "2026-05-11": {
    date: "2026-05-11",
    items: ["友達とランチをした", "読んでいた本の続きが面白かった", "天気が良かった"],
    mood: "good",
    tags: ["友達", "読書"],
  },
  "2026-05-10": {
    date: "2026-05-10",
    items: ["公園で桜の最後の花びらが残っていた", "新しい本を読み終えた", "妹から電話があった"],
    mood: "great",
    tags: ["家族", "読書", "自然"],
  },
  "2026-05-09": {
    date: "2026-05-09",
    items: ["犬の散歩中に虹が見えた", "お気に入りのカフェでゆっくりできた", "良く眠れた"],
    mood: "great",
    tags: ["散歩", "カフェ"],
  },
  "2026-05-08": {
  ...
  "2026-05-06": {
    date: "2026-05-06",
    items: ["新しいレシピに挑戦した", "友達から面白い記事が届いた", "空が綺麗だった"],
    mood: "good",
    tags: ["料理", "友達"],
  },
  "2026-05-05": {
  ...
  "2026-05-02": {
    date: "2026-05-02",
    items: ["仕事がうまく進んだ", "おいしいランチを食べた", "帰り道が気持ちよかった"],
    mood: "good",
    tags: ["仕事"],
  },
  "2026-05-01": {
    date: "2026-05-01",
    items: ["新しい月が始まった", "コーヒーが美味しかった", "音楽を聴きながら仕事できた"],
    mood: "good",
    tags: ["コーヒー", "音楽"],
  },
};
